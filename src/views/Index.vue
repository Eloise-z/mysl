    ...
    <ul class="slides-container">
      <li class="text-center">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h1 class="m-b-20"><strong> 爱农助农<br> 服务三农 </strong></h1>
              <p class="m-b-40">
                <i class="fas fa-at" style="padding-right: 5px;"></i>
                缅怀袁隆平院士 <br></p>
      ...
      <li class="text-center">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h1 class="m-b-20"><i class="fas fa-broadcast-tower" style="padding-right: 5px;"></i><strong>全面小康 <br>
                乡村振兴</strong></h1>
              <p class="m-b-40">助力乡村振兴 <br> 加快农业农村现代化</p>
              <!--   <p><a class="btn hvr-hover" href="#">开始购物</a></p>-->
            </div>
          </div>
        </div>
      </li>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <div class="shop-cat-box">
            ...
            <a class="btn hvr-hover" href="#">新疆棉花</a>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <div class="shop-cat-box">
            <div class="type-lb-out">
              <p class="sale"><i class="fas fa-exclamation-circle"></i>已售罄</p>
            </div>
  ...
  <div class="products-box">
    <div class="container">
        ...
        <div class="col-lg-12">
          <div class="special-menu text-center">
            <div class="button-group filter-button-group">
              <button class="active" data-filter="*">全品</button>
              <button data-filter=".top-featured">蔬菜</button>
              <button data-filter=".best-seller">水果</button>
              <button data-filter=".sale">筛选用data-filter</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row special-list">
        <div class="col-lg-6 col-md-6 special-grid sale best-seller">
          <div class="products-single fix">
            <div class="box-img-hover">
              <div class="type-lb">
                <p class="hot">2列特推商品</p>
              </div>
      ...
      <div class="row special-list">
        <div class="col-lg-3 col-md-6 special-grid sale best-seller">
          <div class="products-single fix">
            <div class="box-img-hover">
              <div class="type-lb">
                <p class="sale">Sale</p>
