    ...
    navbarScrollspy: function() {
      ...
      if (navScrollSpy.length) {
        ...
        $('.scroll').on('click', function(event) {
          ...
          var $section = $($anchor.attr('href')).offset().top
          var $window = $(window).width()
          var $minusDesktop = getNav.data('minus-value-desktop')
          var $minusMobile = getNav.data('minus-value-mobile')
          var $speed = getNav.data('speed')
