    ...
    Selectpicker.prototype = {
      ...
      createLi: function() {
        ...
        $selectOptions.each(function(index) {
          ...
          var inline = htmlEscape(this.style.cssText)
      ...
      setSize: function() {
        ...
        if (this.options.size === 'auto') {
          var getSize = function() {
            ...
            var lis = that.$menuInner[0].getElementsByTagName('a')
            var lisVisible = Array.prototype.filter ? Array.prototype.filter.call(lis, hasClass('d-none', false)) : that.$lis.not('.d-none')
          ...
          var divLength = this.$lis.slice(0, optIndex + 1).filter('.dropdown-divider').length
      ...
      changeAll: function(status) {
        ...
        var $lisVisible = this.$lis.not('.dropdown-divider, .dropdown-header, .disabled, .d-none')
      ...
      keydown: function(e) {
        ...
        var prevIndex
        var isActive
        var selector = ':not(.disabled, .d-none, .dropdown-header, .dropdown-divider)'
        var keyCodeMap = {
          32: ' ',
          48: '0',
          49: '1',
