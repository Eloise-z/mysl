...
+(function(a) {
  ...
  function b(b) {
    return this.each(function() {
      var c = a(this)
      var e = a.extend({},
        d.DEFAULTS, c.data(), typeof b === 'object' && b)
      var f = c.data('bs.validator'); (f || b != 'destroy') && (f || c.data('bs.validator', f = new d(this, e)), typeof b === 'string' && f[b]())
    })
  }
  ...
  d.prototype.validateInput = function(b) {
    var c = a(b.target)
    var d = c.data('bs.validator.errors')
  ...
  d.prototype.runValidators = function(b) {
    function c(a) {
      return b.data(a + '-error') || b.data('error') || a == 'native' && b[0].validationMessage || g.errors[a]
    }
    var e = []
    var f = a.Deferred()
    var g = this.options
    ...
    a.each(d.VALIDATORS, a.proxy(function(a, d) {
      if ((b.data(a) || a == 'native') && !d.call(this, b)) {
        var f = c(a); !~e.indexOf(f) && e.push(f)
      }
    },
    this)),
    !e.length && b.val() && b.data('remote') ? this.defer(b,
      function() {
        var d = {}
        d[b.attr('name')] = b.val(),
  ...
  d.prototype.showErrors = function(b) {
    ...
    this.defer(b,
      function() {
        ...
        var e = d.find('.help-block.with-errors')
        var f = d.find('.form-control-feedback')
        var g = b.data('bs.validator.errors')
  ...
  d.prototype.clearErrors = function(a) {
    ...
    var c = b.find('.help-block.with-errors')
    var d = b.find('.form-control-feedback')
  ...
  d.prototype.isIncomplete = function() {
    function b() {
      return this.type === 'checkbox' ? !this.checked : this.type === 'radio' ? !a('[name="' + this.name + '"]:checked').length : a.trim(this.value) === ''
    }
  ...
  d.prototype.destroy = function() {
    ...
    this.$element.find(c).off('.bs.validator').removeData(['bs.validator.errors', 'bs.validator.deferred']).each(function() {
      var b = a(this)
      var c = b.data('bs.validator.timeout')
      window.clearTimeout(c) && b.removeData('bs.validator.timeout')
    }),
    this.$element.find('.help-block.with-errors').each(function() {
      var b = a(this)
      var c = b.data('bs.validator.originalContent')
