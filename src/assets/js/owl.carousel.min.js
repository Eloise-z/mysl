...
!(function(a, b, c, d) {
  ...
  },
  {
    ...
    run: function() {
      ...
      var c = this._items
      var d = this.settings
      var e = Math.max(2 * d.items, 4)
      var f = 2 * Math.ceil(c.length / 2)
  ...
  },
  {
    ...
    run: function() {
      var a; var b; var c; var d; var e = this.settings.rtl ? 1 : -1
      var f = 2 * this.settings.stagePadding
  ...
  e.prototype.setup = function() {
    ...
    c ? (a.each(c,
      ...
      this.options, c[d]), typeof e.stagePadding === 'function' && (e.stagePadding = e.stagePadding()), delete e.responsive, e.responsiveClass && this.$element.attr('class', this.$element.attr('class').replace(new RegExp('(' + this.options.responsiveClass + '-)\\S+\\s', 'g'), '$1' + d))) : e = a.extend({},
      this.options),
    this.trigger('change', {
      property: {
        name: 'settings',
  ...
  e.prototype.onDragStart = function(b) {
    var d = null
    b.which !== 3 && (a.support.transform ? (d = this.$stage.css('transform').replace(/.*\(|\)| /g, '').split(','), d = {
  ...
  e.prototype.onDragEnd = function(b) {
    ...
    (d.x !== 0 && this.is('dragging') || !this.is('valid')) && (this.speed(this.settings.dragEndSpeed || this.settings.smartSpeed), this.current(this.closest(e.x, d.x !== 0 ? f : this._drag.direction)), this.invalidate('position'), this.update(), this._drag.direction = f, (Math.abs(d.x) > 3 || (new Date()).getTime() - this._drag.time > 300) && this._drag.target.one('click.owl.core',
      function() {
        return !1
      })),
  ...
  e.prototype.closest = function(b, c) {
    ...
    return this.settings.freeDrag || a.each(h, a.proxy(function(a, i) {
      return c === 'left' && b > i - f && b < i + f ? e = a : c === 'right' && b > i - g - f && b < i - g + f ? e = a + 1 : this.op(b, '<', i) && this.op(b, '>', h[a + 1] !== d ? h[a + 1] : i - g) && (e = c === 'left' ? a + 1 : a),
      e === -1
    },
    this)),
  ...
  e.prototype.invalidate = function(b) {
    return a.type(b) === 'string' && (this._invalidated[b] = !0, this.is('valid') && this.leave('valid')),
  ...
  e.prototype.maximum = function(a) {
    var b; var c; var d; var e = this.settings
  ...
  e.prototype.duration = function(a, b, c) {
    return c === 0 ? 0 : Math.min(Math.max(Math.abs(b - a), 1), 6) * Math.abs(c || this.settings.smartSpeed)
  },
  ...
  e.prototype.trigger = function(b, c, d, f, g) {
    ...
    var i = a.camelCase(a.grep(['on', b, d],
      function(a) {
        return a
      }).join('-').toLowerCase())
    ...
    return this._supress[b] || (a.each(this._plugins,
      ...
      type: e.Type.Event,
      name: b
    }), this.$element.trigger(j), this.settings && typeof this.settings[i] === 'function' && this.settings[i].call(this, j)),
    j
  },
  ...
  a.fn.owlCarousel = function(b) {
    ...
    return this.each(function() {
      ...
      f || (f = new e(this, typeof b === 'object' && b), d.data('owl.carousel', f), a.each(['next', 'prev', 'to', 'destroy', 'refresh', 'replace', 'add', 'remove'],
        function(b, c) {
          f.register({
            type: e.Type.Event,
            name: c
...
(function(a, b, c, d) {
  ...
  e.prototype.destroy = function() {
    ...
    for (c in Object.getOwnPropertyNames(this)) typeof this[c] !== 'function' && (this[c] = null)
  },
...
(function(a, b, c, d) {
  ...
  e.prototype.load = function(c) {
    ...
    var e = d && d.find('.owl-lazy'); !e || a.inArray(d.get(0), this._loaded) > -1 || (e.each(a.proxy(function(c, d) {
      var e; var f = a(d)
  ...
  var e = function(c) {
    ...
    this._handlers = {
      ...
      'changed.owl.carousel': a.proxy(function(a) {
        a.namespace && this._core.settings.autoHeight && a.property.name === 'position' && this.update()
      },
      this),
    ...
    a(b).resize(function() {
      d._core.settings.autoHeight && (d._intervalId != null && clearTimeout(d._intervalId), d._intervalId = setTimeout(function() {
        d.update()
      },
      250))
    })
...
(function(a, b, c, d) {
  var e = function(b) {
    ...
    this._handlers = {
      ...
      this),
      'changed.owl.carousel': a.proxy(function(a) {
        a.namespace && a.property.name === 'position' && this._playing && this.stop()
      },
      this),
  ...
  e.prototype.thumbnail = function(b, c) {
    var d; var e; var f; var g = c.width && c.height ? 'width:' + c.width + 'px;height:' + c.height + 'px;' : ''
    var h = b.find('img')
    var i = 'src'
    var j = ''
    ...
    c.type === 'youtube' ? (f = '//img.youtube.com/vi/' + c.id + '/hqdefault.jpg', l(f)) : c.type === 'vimeo' ? a.ajax({
      type: 'GET',
...
(function(a, b, c, d) {
  var e = function(b) {
    ...
    this.handlers = {
      'change.owl.carousel': a.proxy(function(a) {
        a.namespace && a.property.name == 'position' && (this.previous = this.core.current(), this.next = a.property.value)
      },
      this),
  ...
  e.prototype.swap = function() {
    if (this.core.settings.items === 1 && a.support.animation && a.support.transition) {
      this.core.speed(0)
      var b; var c = a.proxy(this.clear, this)
...
(function(a, b, c, d) {
  var e = function(b) {
    ...
    this._handlers = {
      'changed.owl.carousel': a.proxy(function(a) {
        a.namespace && a.property.name === 'settings' ? this._core.settings.autoplay ? this.play() : this.stop() : a.namespace && a.property.name === 'position' && this._paused && (this._time = 0)
      },
      this),
      'initialized.owl.carousel': a.proxy(function(a) {
...
(function(a, b, c, d) {
  ...
  e.prototype.initialize = function() {
    var b; var c = this._core.settings
  ...
  e.prototype.destroy = function() {
    ...
    for (b in this._controls)b === '$relative' && e.navContainer ? this._controls[b].html('') : this._controls[b].remove()
    for (d in this.overides) this._core[d] = this._overrides[d]
    for (c in Object.getOwnPropertyNames(this)) typeof this[c] !== 'function' && (this[c] = null)
  },
  e.prototype.update = function() {
    var a; var b; var c; var d = this._core.clones().length / 2
    var e = d + this._core.items().length
    var f = this._core.maximum(!0)
  ...
  e.prototype.getPosition = function(b) {
    var c; var d; var e = this._core.settings
    return e.slideBy == 'page' ? (c = a.inArray(this.current(), this._pages), d = this._pages.length, b ? ++c : --c, c = this._pages[(c % d + d) % d].start) : (c = this._core.relative(this._core.current()), d = this._core.items().length, b ? c += e.slideBy : c -= e.slideBy),
    c
  },
...
(function(a, b, c, d) {
  ...
  var e = function(c) {
    ...
    this._handlers = {
      'initialized.owl.carousel': a.proxy(function(c) {
        c.namespace && this._core.settings.startPosition === 'URLHash' && a(b).trigger('hashchange.owl.navigation')
      },
      this),
      'prepared.owl.carousel': a.proxy(function(b) {
        if (b.namespace) {
  ...
  e.prototype.destroy = function() {
    ...
    for (d in Object.getOwnPropertyNames(this)) typeof this[d] !== 'function' && (this[d] = null)
  },
