        ...
        function() {
            ...
            function A(e) {
                if (v.hasOwnProperty(e)) {
                    var t = v[e].galleries; [].forEach.call(t,
                        function(e) { [].forEach.call(e,
                            function(e) {
            ...
            function S(i, a) {
                if (d !== i) {
                    ...
                    h.length = 0;
                    for (var s, l = [], c = [], f = 0; f < i.length; f++)(s = W("div")).className = "full-image",
                        s.id = "baguette-img-" + f,
                        h.push(s),
            ...
            function F(t) {
                ...
                "block" !== e.style.display && (D(document, "keydown", P), p = {
                    count: 0,
                    startX: null,
                    startY: null
                },
            ...
            function I() {
                ...
                "none" !== e.style.display && (V(document, "keydown", P), e.className = "", setTimeout(function() {
            ...
            function Y(e, t) {
                var n = h[e],
                    o = d[e];
                if (void 0 !== n && void 0 !== o) if (n.getElementsByTagName("img")[0]) t && t();
                else {
            ...
            function X(e, t) {
                return ! g && e >= 0 && e < t.length ? (S(t, r), F(e), !0) : e < 0 ? (r.animation && M("left"), !1) : e >= h.length ? (r.animation && M("right"), !1) : (Y(f = e,
                    function() {
                        R(f),
                            z(f)
            ...
            function O() {
                ...
                "fadeIn" === r.animation ? (t.style.opacity = 0, setTimeout(function() {
                        c.transforms ? t.style.transform = t.style.webkitTransform = "translate3d(" + e + ",0,0)": t.style.left = e,
                            t.style.opacity = 1
                    },
            ...
            function D(e, t, n, o) {
                e.addEventListener ? e.addEventListener(t, n, o) : e.attachEvent("on" + t,
                    function(e) { (e = e || window.event).target = e.target || e.srcElement,
                        n(e)
                    })
            }
            function V(e, t, n, o) {
            ...
            [].filter || (Array.prototype.filter = function(e, t, n, o, i) {
            ...
            }),
                {
                    run: function(r, u) {
                        var d, f, g, p, b, h;
                        return c.transforms = "undefined" != typeof(d = W("div")).style.perspective || "undefined" != typeof d.style.webkitPerspective,
                            ...
                            function() {
                                if (e = U("baguetteBox-overlay")) return t = U("baguetteBox-slider"),
                                    n = U("previous-button"),
                                    o = U("next-button"),
                                    void(i = U("close-button"));
                                var r; (e = W("div")).setAttribute("role", "dialog"),
                            ...
                            [].forEach.call(b,
                                function(e) {
                                    ...
                                    var t = [];
                                    if (t = "A" === e.tagName ? [e] : e.getElementsByTagName("a"), 0 !== (t = [].filter.call(t,
                                        function(e) {
                                            if ( - 1 === e.className.indexOf(p && p.ignoreClass)) return m.test(e.href)
                                        })).length) {
                                        var n = []; [].forEach.call(t,
                                            function(e, t) {
                                                var o = function(e) {
                                                        e.preventDefault ? e.preventDefault() : e.returnValue = !1,
                                                            S(n, p),
